...
describe('the listGenerator', function() {
    ...
    it('should generate a image link ', function() {
        ...
        expect(response).to.equal('https://cdn.aylamar.com/assets/img/test-item-name.png');
    })

    it('should generate a valid cook list ', function() {
        cookListGenerator()
        expect(cookList["O'dyllita Meal"].name).to.equal("O'dyllita Meal")
        expect(cookList["O'dyllita Meal"].img).to.equal("https://cdn.aylamar.com/assets/img/o'dyllita-meal.png")
        ...
        expect(cookList['Meat Croquette'].img).to.equal("https://cdn.aylamar.com/assets/img/meat-croquette.png")
    ...
    it('should generate a valid production list ', function() {
        ...
        expect(prodList['Calpheon Timber Crate'].img).to.equal("https://cdn.aylamar.com/assets/img/calpheon-timber-crate.png")
        ...
        expect(prodList['Advanced Alchemy Tool'].img).to.equal("https://cdn.aylamar.com/assets/img/advanced-alchemy-tool.png")
