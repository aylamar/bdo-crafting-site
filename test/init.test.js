...
describe('the listGenerator', function() {
    ...
    it('should generate a image link ', function() {
        var response = imgGenerator('Test Item Name');
        expect(response).to.equal('img/test-item-name.png');
    })

    it('should generate a valid cook list ', function() {
        cookListGenerator()
        expect(cookList["O'dyllita Meal"].name).to.equal("O'dyllita Meal")
        expect(cookList["O'dyllita Meal"].img).to.equal("img/o'dyllita-meal.png")
        ...
        expect(cookList['Meat Croquette'].img).to.equal("img/meat-croquette.png")
    ...
    it('should generate a valid production list ', function() {
        ...
        expect(prodList['Calpheon Timber Crate'].img).to.equal("img/calpheon-timber-crate.png")
        ...
        expect(prodList['Advanced Alchemy Tool'].img).to.equal("img/advanced-alchemy-tool.png")
