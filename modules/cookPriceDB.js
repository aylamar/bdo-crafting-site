...
/* Used to fetch all cooking IDs and print all data to the console 
...
async function getPrice() {
    ...
    cookIngredParsed.forEach(element => {
        ...
        jsonArray.push(element.name, {id: element.id, value: element.price})

    });
    console.dir(jsonArray, {'maxArrayLength': null})
}
